...
& $remotion render index.ts MagicDeliveryClimax '..\output\magic-delivery-climax-test.mp4' --codec=h264 --crf=26 --concurrency=4 --public-dir='..\public' --browser-executable=$chrome
