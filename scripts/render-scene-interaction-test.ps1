...
& $remotion render index.ts SceneInteractionTest '..\output\scene-interaction-breakfast-activity-test.mp4' --codec=h264 --crf=24 --concurrency=4 --public-dir='..\public' --browser-executable=$chrome
